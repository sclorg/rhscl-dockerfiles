...
*  **For RHEL based image**
    ```
    $ s2i build https://github.com/openshift/sti-nodejs.git --context-dir=4.3/test/test-app/ openshift/nodejs-4-rhel7 nodejs-sample-app
    $ docker run -p 8080:8080 nodejs-sample-app
    ```

*  **For CentOS based image**
    ```
    $ s2i build https://github.com/openshift/sti-nodejs.git --context-dir=4.3/test/test-app/ openshift/nodejs-4-centos7 nodejs-sample-app
    $ docker run -p 8080:8080 nodejs-sample-app
    ```
